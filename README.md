...
[Portfolio](https://simwoohyun.vercel.app/) · [Email](mailto:wmr06244@naver.com)
...
- 주요 기술: `FastAPI`, `LangChain`, `Pinecone`, `OpenAI`, `BM25`, `RAGAS`, `Docker`
- 핵심 구현:
...
- 주요 기술: `React`, `TypeScript`, `Express`, `PostgreSQL`, `Zod`, `Chart.js`
- 핵심 구현:
...
- 주요 기술: `React`, `TypeScript`, `Zustand`, `TanStack Query`, `Vitest`, `Playwright`
- 핵심 구현:
...
- 주요 기술: `Python`, `Open-Meteo API`, `Google Calendar iCal`, `Telegram Bot API`, `GitHub Actions`
- 핵심 구현:
