...
- **고객 문제 정의**:
  - 중소·중견기업이 경쟁사 기술 동향을 파악하기 어려운 문제를 특허 분석 대시보드로 풀었습니다.
  - B2B AI 서비스의 출시 과정에서 반복 QA와 프론트엔드·백엔드 연결 문제를 찾아 서비스 흐름으로 풀었습니다.
  - 특허 검색과 기술 검토에 필요한 복잡한 탐색 과정을 자연어 검색과 근거 기반 AI 분석으로 풀었습니다.
- **구현 범위**:
